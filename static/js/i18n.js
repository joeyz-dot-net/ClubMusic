...
const translations = {
    zh: {
        ...
        'albums.library': '资料库',
        'albums.title': '专辑',
        'albums.pageSubtitle': '用更像音乐资料库的方式浏览本地专辑',
        'albums.refresh': '刷新',
        'albums.refreshing': '正在刷新专辑资料库...',
        'albums.refreshSuccess': '专辑资料库已刷新',
        'albums.refreshFailed': '刷新专辑失败',
        'albums.empty': '还没有可显示的本地专辑',
        'albums.notFound': '找不到该专辑',
        'albums.featured': '精选专辑',
        'albums.recentlyAdded': '最近加入',
        'albums.allAlbums': '全部专辑',
        'albums.openAlbum': '打开专辑',
        'albums.play': '播放',
        'albums.shuffle': '随机播放',
        'albums.addToQueue': '加入队列',
        'albums.tracks': '曲目',
        'albums.back': '返回',
        'albums.noSongs': '这张专辑里还没有可播放的歌曲',
        'albums.playing': '正在准备播放专辑...',
        'albums.playSuccess': '正在播放《{title}》',
        'albums.playFailed': '播放专辑失败',
        'albums.queueing': '正在将专辑加入队列...',
        'albums.queueSuccess': '已将《{title}》加入「{name}」',
        'albums.queueFailed': '加入队列失败',
        'albums.queueMixed': '《{title}》已加入 {added} 首，跳过 {skipped} 首，失败 {failed} 首',
        'albums.loadFailed': '加载专辑资料库失败',
        'albums.loadSongsFailed': '加载专辑曲目失败',
        'albums.trackPlay': '播放曲目',
        'albums.addTrack': '加入队列',
    ...
    en: {
        ...
        // Albums library
        'albums.library': 'Library',
        'albums.title': 'Albums',
        'albums.pageSubtitle': 'Browse local albums like a music library, not a file browser',
        'albums.refresh': 'Refresh',
        'albums.refreshing': 'Refreshing albums library...',
        'albums.refreshSuccess': 'Albums library refreshed',
        'albums.refreshFailed': 'Failed to refresh albums',
        'albums.empty': 'No local albums to show yet',
        'albums.notFound': 'Album not found',
        'albums.featured': 'Featured Album',
        'albums.recentlyAdded': 'Recently Added',
        'albums.allAlbums': 'All Albums',
        'albums.openAlbum': 'Open album',
        'albums.play': 'Play',
        'albums.shuffle': 'Shuffle',
        'albums.addToQueue': 'Add to Queue',
        'albums.tracks': 'Tracks',
        'albums.back': 'Back',
        'albums.noSongs': 'This album has no playable tracks yet',
        'albums.playing': 'Preparing album playback...',
        'albums.playSuccess': 'Now playing {title}',
        'albums.playFailed': 'Album playback failed',
        'albums.queueing': 'Adding album to queue...',
        'albums.queueSuccess': 'Added {title} to {name}',
        'albums.queueFailed': 'Failed to add album to queue',
        'albums.queueMixed': '{title}: added {added}, skipped {skipped}, failed {failed}',
        'albums.loadFailed': 'Failed to load albums library',
        'albums.loadSongsFailed': 'Failed to load album tracks',
        'albums.trackPlay': 'Play track',
        'albums.addTrack': 'Add to queue',
    ...
    'zh-TW': {
        ...
        'albums.library': '資料庫',
        'albums.title': '專輯',
        'albums.pageSubtitle': '用更像音樂資料庫的方式瀏覽本機專輯',
        'albums.refresh': '重新整理',
        'albums.refreshing': '正在重新整理專輯資料庫...',
        'albums.refreshSuccess': '專輯資料庫已更新',
        'albums.refreshFailed': '重新整理專輯失敗',
        'albums.empty': '還沒有可顯示的本機專輯',
        'albums.notFound': '找不到該專輯',
        'albums.featured': '精選專輯',
        'albums.recentlyAdded': '最近加入',
        'albums.allAlbums': '全部專輯',
        'albums.openAlbum': '打開專輯',
        'albums.play': '播放',
        'albums.shuffle': '隨機播放',
        'albums.addToQueue': '加入佇列',
        'albums.tracks': '曲目',
        'albums.back': '返回',
        'albums.noSongs': '這張專輯裡還沒有可播放的歌曲',
        'albums.playing': '正在準備播放專輯...',
        'albums.playSuccess': '正在播放《{title}》',
        'albums.playFailed': '播放專輯失敗',
        'albums.queueing': '正在將專輯加入佇列...',
        'albums.queueSuccess': '已將《{title}》加入「{name}」',
        'albums.queueFailed': '加入佇列失敗',
        'albums.queueMixed': '《{title}》已加入 {added} 首，跳過 {skipped} 首，失敗 {failed} 首',
        'albums.loadFailed': '載入專輯資料庫失敗',
        'albums.loadSongsFailed': '載入專輯曲目失敗',
        'albums.trackPlay': '播放曲目',
        'albums.addTrack': '加入佇列',
