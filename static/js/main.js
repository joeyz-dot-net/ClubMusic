...
import { playlistManager, renderPlaylistUI, showPlaybackHistory } from './playlist.js?v=9';
import { playlistsManagement } from './playlists-management.js?v=8';
import { volumeControl } from './volume.js?v=3';
import { searchManager } from './search.js?v=12';
