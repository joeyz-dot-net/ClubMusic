...
import { localFiles, getNodeByPath, getDirCoverUrl, countFiles } from './local.js?v=12';
import { playlistManager, renderPlaylistUI } from './playlist.js?v=14';
import { i18n } from './i18n.js';
import { escapeHTML, openOverlayActionMenu, restoreFocus, trapFocusInContainer } from './utils.js';
import { executePlayNow, rerenderQueueWithCurrentMeta } from './playNow.js?v=11';
import { getCurrentPlaybackMeta } from './playbackState.js?v=10';
                ...
                setTimeout(async () => {
                    if (action === 'add-to-queue') {
                        ...
                        if (selectedId !== activeDefault) {
                            ...
                            const { showSelectPlaylistModal } = await import('./playlist.js?v=14');
