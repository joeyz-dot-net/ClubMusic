...
import { playlistManager, renderPlaylistUI } from './playlist.js?v=6';
import { i18n } from './i18n.js';
import { escapeHTML, openOverlayActionMenu, restoreFocus, trapFocusInContainer } from './utils.js';
import { executePlayNow, rerenderQueueWithCurrentMeta } from './playNow.js?v=3';
import { getCurrentPlaybackMeta } from './playbackState.js?v=2';
                ...
                setTimeout(async () => {
                    if (action === 'add-to-queue') {
                        ...
                        if (selectedId !== activeDefault) {
                            ...
                            const { showSelectPlaylistModal } = await import('./playlist.js?v=6');
