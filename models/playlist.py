...
class PlayQueue(BasePlaylist):
    ...
    def play(self, index: int = None, save_to_history: bool = True,
             mpv_command_func=None, mpv_pipe_exists_func=None, 
             ensure_mpv_func=None, add_to_history_func=None, music_dir: str = None) -> bool:
        """播放队列中的歌曲
        ...
        print(f"[DEBUG] PlayQueue.play -> 索引={self._current_index}, 歌曲类型={type(song).__name__}")
    ...
    def play_at_index(self, index: int, save_to_history: bool = True,
                      mpv_command_func=None, mpv_pipe_exists_func=None,
                      ensure_mpv_func=None, add_to_history_func=None, music_dir: str = None) -> bool:
        """在指定索引播放歌曲（设置当前索引并播放）
        ...
        return self.play(index=index, save_to_history=save_to_history,
                        mpv_command_func=mpv_command_func,
                        mpv_pipe_exists_func=mpv_pipe_exists_func,
                        ensure_mpv_func=ensure_mpv_func,
                        add_to_history_func=add_to_history_func,
    ...
    def play_next(self, save_to_history: bool = True,
                  mpv_command_func=None, mpv_pipe_exists_func=None,
                  ensure_mpv_func=None, add_to_history_func=None, music_dir: str = None) -> bool:
        """播放下一首歌曲
        ...
        return self.play(save_to_history=save_to_history,
                        mpv_command_func=mpv_command_func,
                        mpv_pipe_exists_func=mpv_pipe_exists_func,
                        ensure_mpv_func=ensure_mpv_func,
                        add_to_history_func=add_to_history_func,
...
class PlayHistory(BasePlaylist):
    ...
    def add_to_history(self, url_or_path: str, name: str, is_local: bool = False):
        """添加项目到历史记录
